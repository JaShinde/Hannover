...
bindings: function(){
	...
	$(document).on('change','#empID',function(e){
				   ...
				   $("#emp_details").empty().append('<li class="ui-li ui-li-static ui-btn-up-c">Employee Name: XXXXXX</li><li class="ui-li ui-li-static ui-btn-up-c">Age: XX Years</li><li class="ui-li ui-li-static ui-btn-up-c">Employee Department: XXXXXXXX</li><li class="ui-li ui-li-static ui-btn-up-c">Employee Location: XXXXXXX</li>');
				   $( "#emp_details" ).listview( "refresh" );
				   }
				   });
